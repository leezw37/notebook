...
3. MT文件管理器，设置为默认
4. 开发者选项/无障碍设置，关闭动画
5. 设置，网络和互联网，sim卡，首选网络类型，选NR/LTE/TDSCDMA/开头的，从而打开NR，5G
6. 设置，默认应用，主屏幕应用，隐藏和保护应用
7. 传微信，clash，节点订阅
8. 设置，系统，状态栏，开启网络流量监视
9. magisk可能干扰微信、中国银行等的人脸验证，在magisk设置中伪装隐藏，但仍然可能无效
10. 天气软件weewow完美适配系统日历，闹钟等
11. 
